...
#define __SIZE_T__
#if defined(LINUX8664) || defined(TARGET_OSX_X8664) || defined(TARGET_LLVM_64) || defined(FREEBSD8664)
...
#if defined(LINUX) && defined(PGLF64) || defined(FREEBSD) && defined(PGLF64) /* LINUX 64-bit filesystems */
...
#elif defined(LINUX) && defined(PGLF64) || defined(FREEBSD) && defined(PGLF64) /* LINUX 64-bit filesystems */
...
#if defined(LINUX) && defined(PGLF64) || defined(FREEBSD) && defined(PGLF64)
