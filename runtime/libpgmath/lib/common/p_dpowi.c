...
#if	defined (TARGET_LINUX_GENERIC) || defined (TARGET_LINUX_POWER) || defined (LINUX8664) || defined (TARGET_X8664) || defined(TARGET_LINUX_ARM64) || defined (TARGET_FREEBSD_GENERIC) || defined (TARGET_FREEBSD_POWER) || defined (FREEBSD8664) || defined (TARGET_X8664) || defined(TARGET_FREEBSD_ARM64)
