...
extern "C" __m256d __fvd_acos_fma3_256(__m256d);

__m256d __fvd_acos_fma3_256(__m256d const a)
{
    ...
    __m256d const N0 = _mm256_set1_pd(N0_D);
    ...
    __m256d const M1 = _mm256_set1_pd(M1_D);

    __m256d x, x2, a3, x6, x12, a15, c;
    __m256d sq, p0, p1;
    ...
    p1hi = _mm256_fmadd_pd(p1hi, x, G1);
    x6 = _mm256_mul_pd(a3, a3);
    p1lo = _mm256_fmadd_pd(p1lo, x, M1);
    __m256d pi_mask = _mm256_cmp_pd(ZERO, a, _CMP_GT_OQ);
    ...
    __m256d pi_hi = _mm256_and_pd(pi_mask, PI_HI);
    ...
    c = _mm256_sub_pd(N0, a);

    p1 = _mm256_fmsub_pd(sq, p1, pi_hi);
    fix = _mm256_xor_pd(fix, sign);
    p0hi = _mm256_fmadd_pd(p0hi, x2, G0);
    a15 = _mm256_mul_pd(x12, a3);
    p0lo = _mm256_fmadd_pd(p0lo, a3, c);

    p1 = _mm256_xor_pd(p1, fix);
    p0 = _mm256_fmadd_pd(p0hi, a15, p0lo);
